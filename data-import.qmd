...
Para cada columna, extrae los valores de 1000 filas \[\^data-import-2\] espaciadas uniformemente desde la primera fila hasta la última, ignorando los valores faltantes.
...
También es posible anular la heurística predeterminada que determina el tipo de forma automática cambiando de `list()` a `cols()`:
