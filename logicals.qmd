...
@fig-bool-ops muestra ejemplos de operaciones booleanas comúnmente utilizadas y cómo funcionan.
...
#| out-width: NULL
#| fig-cap: > 
#|    Ub conjunto de operaciones booleanas comúnmente utilizadas. `x` es el círculo a la
